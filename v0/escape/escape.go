...
func (e *escaper) computeOutCtx(c context, t *parse.DefineNode) context {
	...
	if !ok && c1.state != stateError {
		return context{
			...
			err: errorf(ErrOutputContext, 0, "cannot compute output context for template %q", t.Name),
		}
	}
	return c1
}
...
func (e *escaper) escapeTemplateBody(c context, t *parse.DefineNode) (context, bool) {
	...
	// take the fast path out of escapeDefine instead of infinitely recursing.
